...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default='./results/h36m/models/ckpt_ema_1000.pt', help='./results/h36m/models/ckpt_ema_1000.pt' or './results/he/models/ckpt_ema_500.pt')
    ...
    parser.add_argument("--ode_method", default="euler", choices=list(SOLVERS.keys()) + ["edm_heun"],help="ODE solver used to generate samples.")
